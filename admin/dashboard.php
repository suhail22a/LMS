        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-3 col-sm-3 col-xs-6">
                    ...
                    <a href = 'manage-books.php' ><i class="fa fa-book fa-5x"></i></a>
                        <?php 
                ...
                <div class="col-md-3 col-sm-3 col-xs-6">
                    ...
                    <a href = 'manage-books.php' ><i class="fa fa-bars fa-5x"></i></a>
                        <?php 
                ...
                <div class="col-md-3 col-sm-3 col-xs-6">
                    ...
                    <a href = 'manage-books.php' ><i class="fa fa-recycle fa-5x"></i></a>
                        <?php 
                        $status = 1;
            ...
            <div class="row">
                <div class="col-md-3 col-sm-3 col-xs-6">
                    <div class="alert alert-success back-widget-set text-center">
                    <a href = 'manage-publications.php' ><i class="fa fa-user fa-5x"></i></a>
                        <?php 
                ...
                <div class="col-md-3 col-sm-3 col-xs-6">
                    <div class="alert alert-info back-widget-set text-center">
                    <a href = 'manage-categories.php' ><i class="fa fa-file-archive-o fa-5x"></i></a>
                        <?php 
                ...
                <div class="col-md-3 col-sm-3 col-xs-6">
                    <div class="alert alert-info back-widget-set text-center">
                    <a href = 'set-fine.php' ><i class="fa fa-money fa-5x"></i></a>
                        <?php 
                ...
                <div class="col-md-3 col-sm-3 col-xs-6">
                    <div class="alert alert-info back-widget-set text-center">
                    <a href = '../signup.php' ><i class="fa fa-user fa-5x"></i></a>
                        <br><br><br>
